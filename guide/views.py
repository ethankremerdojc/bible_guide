...
verses_text = """Now there was a man of the Pharisees named Nicodemus, a ruler of the Jews. 
...
def wrap_each_word_in_span(text):
    words = text.split(" ")
    return "".join([ f'<span class="verse-word">{word}</span>' for word in words ])
